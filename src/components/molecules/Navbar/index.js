...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { title: "Certificates", link: "/certificate", icon: <ImBlog /> },
  ];
  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <h1 className="text-2xl text-primary font-lobster">Rafael Santos</h1>
          </Link>
        </div>
        <div>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-neutral">
                  &copy; Copyright 2022, Rafael Santos. All Rights Reserved
                </p>
              </div>
            </Drawer>
          </div>
