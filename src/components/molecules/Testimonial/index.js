...
const Testimonial = () => {
  ...
  return (
    <div className="py-12 parent">
      ...
      >
        <h3 className="text-center text-neutral">Congratulations!</h3>
            ...
            <div key={review.id} className="mt-6">
              ...
              >
                ...
                <div className="flex justify-end px-6 py-2 mt-12 rounded-b bg-primary">
                  <div className=" mt-5 text-center  text-[#1f345e] text-3xl">
                    <h2 className="font-medium leading-none">{review.name}</h2>
                    <p className="text-xs leading-none mt-5">{review.bio}</p>
                  </div>
                  <img
                    src={review.img}
                    alt="client"
                    className="inline-block w-40 h-40 -mt-10 bg-white rounded-full"
                  />
                </div>
              </div>
            </div>
